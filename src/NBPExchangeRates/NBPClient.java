...
public class NBPClient {
  ...
  public static java.lang.String GetExactTableLink(DateTime date) {
    try {
      java.lang.String res =
          Javonet.getType("NBPExchangeRates.NBPClient").invoke("GetExactTableLink", date);
      if (res == null) return "";
  ...
  public static java.lang.String GetLatestTableLink(DateTime date) {
    try {
      java.lang.String res =
          Javonet.getType("NBPExchangeRates.NBPClient").invoke("GetLatestTableLink", date);
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public static NBPExchangeRate GetLatestExchangeRate(
    ...
    try {
      Object res =
          Javonet.getType("NBPExchangeRates.NBPClient")
              .invoke("GetLatestExchangeRate", date, currencySymbol);
